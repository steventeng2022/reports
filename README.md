...
**Total primary findings across all sites: 5437** (High: 19, Medium: 26, Low: 1624, Info: 3768)
...
| amazon.com | 15 | 0 | 0 | 6 | 9 | [Amazon](https://hackerone.com/amazonvrp) |
...
| amzn.com | 17 | 0 | 0 | 6 | 11 | top-websites gist (no active program match) |
| amzn.to | 13 | 0 | 0 | 6 | 7 | top-websites gist (no active program match) |
...
| baidu.com | 12 | 0 | 0 | 7 | 5 | [Baidu](https://bsrc.baidu.com/v2/#/en) |
...
| chronicle.com | 9 | 0 | 0 | 1 | 8 | top-websites gist (no active program match) |
...
| edx.org | 10 | 0 | 0 | 2 | 8 | top-websites gist (no active program match) |
...
| epa.gov | 9 | 0 | 0 | 1 | 8 | top-websites gist (no active program match) |
...
| filezilla-project.org | 1 | 0 | 0 | 0 | 1 | [FileZilla](https://hackerone.com/filezilla) |
...
| maps.google.com | 10 | 0 | 0 | 4 | 6 | [Google](https://www.google.com/about/appsecurity/reward-program/) |
...
| google.be | 13 | 0 | 1 | 8 | 4 | top-websites gist (no active program match) |
| google.co.za | 13 | 0 | 1 | 8 | 4 | top-websites gist (no active program match) |
| google.it | 13 | 0 | 1 | 8 | 4 | top-websites gist (no active program match) |
| inc.com | 3 | 0 | 0 | 1 | 2 | top-websites gist (no active program match) |
...
| telegram.org | 7 | 0 | 3 | 1 | 3 | top-websites gist (no active program match) |
