...
| 11 | info | I5 | Open redirect candidate refuted (canonicalizes to google.com) | CWE-601 |
| 12 | info | R1 | HTTP redirect chain ends at HTTPS | CWE-319 |
...
### 11. [INFO] Open redirect candidate refuted (canonicalizes to google.com) (`I5`)

- **CWE:** CWE-601
- **Detail:** https://google.de/?next=301s to https://www.google.com/ discarding the next parameter entirely.
- **Recommendation:** Review and remediate per CWE guidance.

### 12. [INFO] HTTP redirect chain ends at HTTPS (`R1`)

- **CWE:** CWE-319
- **Detail:** http://google.de 301s through http://www.google.de and http://www.google.com before 302ing to https://www.google.com; the chain terminates on HTTPS.
...
{
  "http_status": 301,
  "http_redirect_to": "http://www.google.de/",
  "https_status": 301,
  ...
  "open_redirect": {
    ...
    "location": "https://www.google.de/?next=https%3A%2F%2Fevil-cors.example%2Fx"
  }
}
```
