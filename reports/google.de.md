...
- **CWE:** CWE-319
- **Detail:** Location: http://www.google.de/
- **Context:** https response, /
...
- **CWE:** CWE-922
- **Detail:** Response for https://google.de/ carries Cache-Control: public, max-age=2592000; shared/shared-CDN caches may store the document (passive cache-poisoning surface).
- **Recommendation:** Use no-store for personalized HTML or verify strict cache keys and Vary headers.

### 16. [INFO] Reverse-DNS (PTR) fingerprint of apex IP (`PTR1`)

- **CWE:** CWE-200
- **Detail:** 142.250.204.35 carries PTR lctsaa-ac-in-f3.1e100.net., hkg07s38-in-f3.1e100.net. for google.de.
...
```json
{
  ...
  "tls2": {
    ...
    "cert": {
      ...
      "aia_ocsp": null,
      "not_before": "20260910192448",
      "not_after": "20261203192447"
    }
  },
  "http2": {
    "robots_disallow": [
