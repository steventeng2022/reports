...
- **CWE:** CWE-603
- **Detail:** Certificate of adssettings.google.com has no Authority Information Access OCSP entry.
- **Recommendation:** Enable OCSP (and stapling) so revocation can be checked.

### 9. [INFO] Cookie scoped to parent domain (.google.com) (`CK5`)

- **CWE:** CWE-200
- **Detail:** Set-Cookie Domain attribute is broader than the request host adssettings.google.com.
- **Recommendation:** Confirm the wider cookie scope is intended.

### 10. [LOW] Redirect chain of 5+ hops on the site root (`RED9`)

- **CWE:** CWE-601
- **Detail:** Following https://adssettings.google.com/ produced 6 redirect hops.
...
```json
{
  ...
  "cors": [
    ...
    {
      "origin": "https://sub.adssettings.google.com",
      "acao": "",
      "acac": ""
    }
  ],
  "http": {
    "status": 301,
    "location": "https://adssettings.google.com/"
  },
  "redir_probes": [
