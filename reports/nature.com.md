...
| Test date | 2026-09-25 00:37 UTC |
...
| 13 | info | R1 | HTTP redirect chain ends at HTTPS with HSTS | CWE-319 |
...
- **CWE:** CWE-200
- **Detail:** Server header reveals: ee-www-redirect
- **Context:** http response
...
### 13. [INFO] HTTP redirect chain ends at HTTPS with HSTS (`R1`)

- **CWE:** CWE-319
- **Detail:** http://nature.com -> 301 http://www.nature.com/ -> 301 https://www.nature.com/ -> 303 to idp.nature.com with Strict-Transport-Security max-age=31536000; preload. Re-verified 2026-09-25: the chain terminates at HTTPS with HSTS preload, so the initial plain-HTTP hop is only a bootstrap concern.
...
- timing base=431ms id=405 search=408
...
{
  "http_status": 301,
  "http_redirect_to": "http://www.nature.com/",
  "https_status": 301,
  "content_type": "",
  "title": "",
  "path_gitconfig": 301,
