...
| 19 | info | CT1 | 5 hostnames found via Certificate Transparency (crt.sh) | CWE-200 |
...
- **CWE:** CWE-603
- **Detail:** Certificate of buzzfeednews.com has no Authority Information Access OCSP entry.
...
### 19. [INFO] 5 hostnames found via Certificate Transparency (crt.sh) (`CT1`)
