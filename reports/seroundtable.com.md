...
- **CWE:** CWE-200
- **Detail:** TCP connect to 172.67.69.148:8080 succeeded (state-only check, no payload sent).
- **Recommendation:** If the service is not required publicly, close the port or restrict by network.

### 3. [INFO] Alternate web service (port 8443) reachable (`PRT8443`)

- **CWE:** CWE-200
- **Detail:** TCP connect to 172.67.69.148:8443 succeeded (state-only check, no payload sent).
- **Recommendation:** If the service is not required publicly, close the port or restrict by network.
...
- **CWE:** CWE-200
- **Detail:** Apex TXT records with verification/token content: google-site-verification=Xdunnteqo7VS3wRH2WgXz8dDsKOagfajHjjln9Pr9bQ
- **Recommendation:** Review published verification records; they confirm domain ownership to third parties.

### 17. [INFO] No OCSP responder URL in certificate (no stapling possible) (`OCSP3`)

- **CWE:** CWE-603
- **Detail:** Certificate of seroundtable.com has no Authority Information Access OCSP entry.
- **Recommendation:** Enable OCSP (and stapling) so revocation can be checked.

### 18. [INFO] robots.txt discloses disallowed paths (asset map) (`ROB1`)

- **CWE:** CWE-200
- **Detail:** robots.txt lists 3 disallow path(s), e.g. /boyfriend-spammed-12909.html, /t.php, /t2e.php
...
```json
{
  ...
  "tls": {
    ...
    "subject": "commonName=seroundtable.com",
    "issuer": "countryName=US, organizationName=Google Trust Services, commonName=WE1",
    "notBefore": "Sep  7 18:07:01 2026 GMT",
    "notAfter": "Dec  6 19:06:51 2026 GMT",
    "san": [
      "seroundtable.com",
      "*.seroundtable.com"
    ],
  ...
  "cors": [
    ...
    {
      "origin": "https://sub.seroundtable.com",
      "acao": "",
      "acac": ""
    }
  ],
  "http": {
    "status": 301,
    "location": "https://www.seroundtable.com/"
  },
  "redir_probes": [
