...
- **CWE:** CWE-614
- **Detail:** Set on https://amazon.in/ without Secure: ak_bmsc. Will be transmitted over HTTP if the site is reachable cleartext.

### 2. [LOW] Cookies set without SameSite Lax/Strict (`C3`)

- **CWE:** CWE-1004
- **Detail:** Set on https://amazon.in/ without SameSite=Lax/Strict: ak_bmsc. Cross-site request cookies.
...
- https://amazon.in/ final status: 200 (final URL https://www.amazon.in/).
