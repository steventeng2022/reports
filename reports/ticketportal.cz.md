...
- **CWE:** CWE-200
- **Detail:** TCP connect to 104.18.3.52:8080 succeeded (state-only check, no payload sent).
- **Recommendation:** If the service is not required publicly, close the port or restrict by network.

### 3. [INFO] Alternate web service (port 8443) reachable (`PRT8443`)

- **CWE:** CWE-200
- **Detail:** TCP connect to 104.18.3.52:8443 succeeded (state-only check, no payload sent).
- **Recommendation:** If the service is not required publicly, close the port or restrict by network.
...
- **CWE:** CWE-319
- **Detail:** http:// root answered 302 -> https://www.ticketportal.cz/.
- **Context:** https response, /
...
```json
{
  ...
  "tls": {
    ...
    "subject": "commonName=ticketportal.cz",
    "issuer": "countryName=US, organizationName=Let's Encrypt, commonName=YE2",
    "notBefore": "Sep  7 19:58:59 2026 GMT",
    "notAfter": "Dec  6 19:58:58 2026 GMT",
    "san": [
      "*.ticketportal.cz",
      "ticketportal.cz"
    ],
  ...
  "cors": [
    ...
    {
      "origin": "https://sub.ticketportal.cz",
      "acao": "",
      "acac": ""
    }
  ],
  "http": {
    "status": 302,
    "location": "https://www.ticketportal.cz/"
  },
  "redir_probes": [
