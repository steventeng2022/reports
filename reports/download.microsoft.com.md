...
- **CWE:** CWE-922
- **Detail:** Response for https://download.microsoft.com/ carries Cache-Control: max-age=900; shared/shared-CDN caches may store the document (passive cache-poisoning surface).
...
```json
{
  ...
  "tls": {
    ...
    "subject": "countryName=US, stateOrProvinceName=WA, localityName=Redmond, organizationName=Microsoft Corporation, commonName=akamai.download.microsoft.com",
    "issuer": "countryName=US, organizationName=Microsoft Corporation, commonName=Microsoft TLS G2 ECC CA OCSP 02",
    "notBefore": "Sep 10 03:55:29 2026 GMT",
    "notAfter": "Mar 27 03:55:29 2027 GMT",
    "san": [
  ...
  "cors": [
    ...
    {
      "origin": "https://sub.download.microsoft.com",
      "acao": "",
      "acac": ""
    }
  ],
  "http": {
    "status": 301,
    "location": "https://www.microsoft.com/download"
  },
  "redir_probes": [
