...
- **CWE:** CWE-200
- **Detail:** Detected: Server: myracloud
...
- **CWE:** CWE-200
- **Detail:** Header reveals: myracloud
- **Context:** https response, /
...
- **CWE:** CWE-200
- **Detail:** Apex TXT records with verification/token content: google-site-verification=O6K8miDfoyFI4IjIQ13207kl978tUNg1HYv3G-bLabo
- **Recommendation:** Review published verification records; they confirm domain ownership to third parties.

### 16. [INFO] No OCSP responder URL in certificate (no stapling possible) (`OCSP3`)

- **CWE:** CWE-603
- **Detail:** Certificate of php.net has no Authority Information Access OCSP entry.
...
```json
{
  ...
  "dns": {
    ...
    "dmarc": [
      "v=DMARC1; p=none; rua=mailto:dmarc@php.net;"
    ],
  ...
  "tls": {
    ...
    "subject": "commonName=*.php.net",
    "issuer": "countryName=US, organizationName=Let's Encrypt, commonName=YE2",
    "notBefore": "Aug 20 04:07:28 2026 GMT",
    "notAfter": "Nov 18 04:07:27 2026 GMT",
    "san": [
      "*.php.net",
      "php.net"
    ],
