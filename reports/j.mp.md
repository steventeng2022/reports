...
- **CWE:** CWE-319
- **Detail:** http://j.mp returns 404 without redirecting to HTTPS.
...
### 9. [INFO] Additional responsive paths (v4 sweep) (`C12i`)

- **CWE:** CWE-538
- **Detail:** Answered without 404: /api -> 410; /wp-login.php -> 410.
...
### 14. [INFO] Host header reflection (`I7`)

- **CWE:** CWE-200
- **Detail:** Host-header reflection not reproduced on re-test: responses for Host: j.mp and Host: evil-host.example are byte-identical (6071 bytes) and the hostile value does not appear in the body.
...
- timing base=205ms id=217 search=291
- boolean b=404/6071 t1=404/6071 t2=404/6071
- graphql /graphql -> 301
