...
| Test date | 2026-09-24 22:11 UTC |
...
- **CWE:** CWE-538
- **Detail:** Paths answering 401/403 or HTML shells: /admin (HTML shell), /console (HTML shell), /dashboard (HTML shell), /api (401 protected), /api/v1 (401 protected), /debug (HTML shell), /trace (HTML shell), /phpmyadmin (HTML shell), /actuator (HTML shell), /actuator/env (HTML shell), /backup (HTML shell), /database (HTML shell) (13 total).
...
- sweep: {"high":[],"protected":["/admin (HTML shell)","/console (HTML shell)","/dashboard (HTML shell)","/api (401 protected)","/api/v1 (401 protected)","/debug (HTML shell)","/trace (HTML shell)","/phpmyadmin (HTML shell)","/actuator (HTML shell)","/actuator/env (HTML shell)","/backup (HTML shell)","/database (HTML shell)","/metrics (HTML shell)"]}

Stage-2 probe log (observed responses):
- timing base=4914ms id=4358 search=1432
...
**Stage 3 - live parameter harvest, takeover and injection probes (21 requests):**
...
{
  "http_status": 301,
  "http_redirect_to": "https://telegram.me/",
  "https_status": 302,
