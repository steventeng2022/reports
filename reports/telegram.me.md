...
- **CWE:** CWE-345
- **Detail:** Two random labels (vmsosipzooq0zs.telegram.me and pblh3vqmt7zuze.telegram.me) both resolve to the same addresses; any random subdomain resolves, weakening dangling-subdomain detection and enlarging virtual-host surface.
- **Recommendation:** Remove the wildcard record or use distinct records for live subdomains.

### 15. [INFO] No OCSP responder URL in certificate (no stapling possible) (`OCSP3`)

- **CWE:** CWE-603
- **Detail:** Certificate of telegram.me has no Authority Information Access OCSP entry.
