...
- **CWE:** CWE-200
- **Detail:** TCP connect to 45.55.41.223:22 succeeded (state-only check, no payload sent).
...
- **CWE:** CWE-603
- **Detail:** Certificate of sublimetext.com has no Authority Information Access OCSP entry.
...
```json
{
  ...
  "dns": {
    ...
    "dmarc": [
      "v=DMARC1; p=quarantine; ruf=mailto:dmarc@sublimetext.com"
    ],
  ...
  "tls": {
    ...
    "subject": "commonName=sublimetext.com",
    "issuer": "countryName=US, organizationName=Let's Encrypt, commonName=YR1",
    "notBefore": "Aug 26 21:31:37 2026 GMT",
    "notAfter": "Nov 24 21:31:36 2026 GMT",
    "san": [
      "sublimetext.com",
      "www.sublimetext.com"
    ],
  ...
  "cors": [
    ...
    {
      "origin": "https://sub.sublimetext.com",
      "acao": "",
      "acac": ""
    }
  ],
  "http": {
    "status": 301,
    "location": "https://www.sublimetext.com/"
  },
  "redir_probes": [
