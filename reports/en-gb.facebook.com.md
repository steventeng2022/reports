# Security Audit Report — en-gb.facebook.com

## Scope and authorization

| Item | Value |
|---|---|
| Target | https://en-gb.facebook.com/ |
| Bug bounty program | [Facebook](https://www.facebook.com/whitehat) |
| Listed scope domain | en-gb.facebook.com |
...
- **CWE:** CWE-298
- **Detail:** Certificate expires 2026-10-02T23:59:59+00:00 (8 days left) for en-gb.facebook.com.

### 2. [INFO] Extra names enumerated from certificate SANs (`D1`)

- **CWE:** CWE-1382
- **Detail:** Certificate for en-gb.facebook.com lists 11 name(s) besides the scope host: *.facebook.com, *.facebook.net, *.fbcdn.net, *.fbsbx.com, *.m.facebook.com, *.messenger.com, *.xx.fbcdn.net, *.xy.fbcdn.net...
...
- **CWE:** CWE-200
- **Detail:** No Referrer-Policy header on https://en-gb.facebook.com/; full URL (incl. query strings) is sent as referrer by default.

### 6. [INFO] Missing Permissions-Policy (`H7`)

- **CWE:** CWE-200
- **Detail:** No Permissions-Policy header on https://en-gb.facebook.com/; browser features (camera, mic, geolocation) unrestricted.

### 7. [INFO] HTTP correctly redirects to HTTPS (`N2`)

- **CWE:** CWE-319
- **Detail:** http://en-gb.facebook.com/ -> https://en-gb.facebook.com/ (positive check).

### 8. [INFO] robots.txt discloses crawl rules/paths (`R1`)

- **CWE:** CWE-200
- **Detail:** robots.txt on https://en-gb.facebook.com/ exposes 44 unique Disallow path(s) (/, /*/plugins/*, /?*next=, /a/bz?, /ajax/)

### 9. [INFO] HTTPS homepage returned HTTP 400 (`X2`)

- **CWE:** CWE-200
- **Detail:** https://en-gb.facebook.com/ responded 400 (passive check only; no further probing).
...
- https://en-gb.facebook.com/ final status: 400 (final URL https://en-gb.facebook.com/).
- http://en-gb.facebook.com/ initial status: 301.
