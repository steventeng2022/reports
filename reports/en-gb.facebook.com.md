...
- **CWE:** CWE-1038
- **Detail:** Verified: GET https://en-gb.facebook.com/.env returns 200 with Facebook SPA headers; body is HTML application fallback, not an env file. Informational.
...
{
  "http_status": 301,
  "http_redirect_to": "https://en-gb.facebook.com/",
  "https_status": 200,
