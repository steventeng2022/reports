...
- **CWE:** CWE-942
- **Detail:** Origin https://sub.platform.twitter.com was echoed in Access-Control-Allow-Origin.
- **Context:** https response, /
...
- **CWE:** CWE-603
- **Detail:** Certificate of platform.twitter.com has no Authority Information Access OCSP entry.
...
```json
{
  ...
  "dns": {
    ...
    "aaaa": [],
    "cname": "platform.twitter.map.fastly.net.",
    "mx": [],
    "ns": [],
    "spf": [],
    "dmarc": [],
  ...
  "cors": [
    ...
    {
      "origin": "https://sub.platform.twitter.com",
      "acao": "*",
      "acac": ""
    }
  ],
