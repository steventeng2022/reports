...
| 17 | info | CT1 | 100 hostnames found via Certificate Transparency (certspotter) | CWE-200 |
...
- **CWE:** CWE-319
- **Detail:** http:// root answered 302 -> https://golang.org/.
- **Context:** https response, /
...
- **CWE:** CWE-345
- **Detail:** Two random labels (bnwjr77o2sxazh.golang.org and 198wdhcq2bhp79.golang.org) both resolve to the same addresses; any random subdomain resolves, weakening dangling-subdomain detection and enlarging virtual-host surface.
...
- **CWE:** CWE-1021
- **Detail:** Content-Security-Policy of golang.org permits unsafe-inline; inline script injection still executes.
...
### 17. [INFO] 100 hostnames found via Certificate Transparency (certspotter) (`CT1`)
...
```json
{
  ...
  "subdomains": {
    ...
    "notable": [],
    "sample": [
      "alt04691.farmer.golang.org",
      "alt046912.gomotessh.golang.org",
      "alt046913.gomotessh.golang.org",
      "alt04692024.farmer.golang.org",
      "alt04692024.gomotessh.golang.org",
      "alt04692025.gomotessh.golang.org",
      "alt04695.gomotessh.golang.org",
      "alt0551.gomotessh.golang.org",
      "alt05510.farmer.golang.org",
      "alt05511.farmer.golang.org",
      "alt05511.gomotessh.golang.org",
      "alt0552019.farmer.golang.org",
      "alt0552020.farmer.golang.org",
      "alt0552020.gomotessh.golang.org",
      "alt0558.farmer.golang.org",
      "alt0559.gomotessh.golang.org",
      "alt0641.gomotessh.golang.org",
      "alt06410.farmer.golang.org",
      "alt06412.gomotessh.golang.org",
