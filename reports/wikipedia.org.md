...
- **CWE:** CWE-200
- **Detail:** Detected: Server: mw-web.eqiad.main-5c56dd8bb-5p97p
...
- **CWE:** CWE-200
- **Detail:** Header reveals: mw-web.eqiad.main-5c56dd8bb-5p97p
- **Context:** https response, /
...
- **CWE:** CWE-200
- **Detail:** Apex TXT records with verification/token content: yandex-verification: 35c08d23099dc863; google-site-verification=AMHkgs-4ViEvIJf5znZle-BSE2EPNFqM1nDJGRyn2qk
- **Recommendation:** Review published verification records; they confirm domain ownership to third parties.

### 14. [INFO] No OCSP responder URL in certificate (no stapling possible) (`OCSP3`)

- **CWE:** CWE-603
- **Detail:** Certificate of wikipedia.org has no Authority Information Access OCSP entry.
...
```json
{
  ...
  "mixed_content": [],
  "tech": [
    "Server: mw-web.eqiad.main-5c56dd8bb-5p97p"
  ],
  "cookies": [
    {},
    {
