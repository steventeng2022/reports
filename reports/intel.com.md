...
- **CWE:** CWE-1382
- **Detail:** Certificate for intel.com lists 58 name(s) besides the scope host: 01.org, acpica.org, barefootnetworks.com, buyaltera.com, dml-lang.org, easic.com, exploreintel.com, granulate.io... (25 no longer resolve)

### 3. [INFO] Possible dangling subdomain (`D2`)

- **CWE:** CWE-1382
- **Detail:** Certificate lists `01.org` but it no longer resolves in DNS; stale DNS/CNAME may point at a taken-over service.

### 4. [INFO] Possible dangling subdomain (`D2`)

- **CWE:** CWE-1382
- **Detail:** Certificate lists `acpica.org` but it no longer resolves in DNS; stale DNS/CNAME may point at a taken-over service.

### 5. [INFO] Possible dangling subdomain (`D2`)

- **CWE:** CWE-1382
- **Detail:** Certificate lists `barefootnetworks.com` but it no longer resolves in DNS; stale DNS/CNAME may point at a taken-over service.
