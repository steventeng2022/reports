...
- **CWE:** CWE-614
- **Detail:** Cookie country lacks Secure attribute; transmitted over HTTP.
- **Recommendation:** Add the Secure attribute to the cookie.

### 2. [LOW] Cookie without HttpOnly flag (`C2`)

- **CWE:** CWE-1004
- **Detail:** Cookie country lacks HttpOnly; readable by client-side JS.
...
{
  "http_status": 301,
  "http_redirect_to": "https://abc.com/",
  "https_status": 200,
