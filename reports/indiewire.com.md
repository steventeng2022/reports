...
- **CWE:** CWE-603
- **Detail:** Certificate of indiewire.com has no Authority Information Access OCSP entry.
- **Recommendation:** Enable OCSP (and stapling) so revocation can be checked.

### 16. [INFO] HSTS present but domain not in the HSTS preload list (`HSTSP`)

- **CWE:** CWE-319
- **Detail:** Strict-Transport-Security is served but indiewire.com is not listed in the HSTS preload list.
- **Recommendation:** Submit the domain to the HSTS preload list (requires includeSubDomains + long max-age).

### 17. [INFO] robots.txt discloses disallowed paths (asset map) (`ROB1`)

- **CWE:** CWE-200
- **Detail:** robots.txt lists 35 disallow path(s), e.g. /wp-admin/, /?s=, /*/?s=, /search/, /search?
...
```json
{
  ...
  "tls": {
    ...
    "subject": "commonName=indiewire.com",
    "issuer": "countryName=US, organizationName=Let's Encrypt, commonName=YE2",
    "notBefore": "Aug 18 14:49:10 2026 GMT",
    "notAfter": "Nov 16 14:49:09 2026 GMT",
    "san": [
      "indiewire.com",
      "www.indiewire.com"
    ],
  ...
  "cors": [
    ...
    {
      "origin": "https://sub.indiewire.com",
      "acao": "",
      "acac": ""
    }
  ],
