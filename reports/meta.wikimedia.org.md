...
- **CWE:** CWE-200
- **Detail:** Detected: Server: mw-web.eqiad.main-5fb6d6bf94-xghvb
...
- **CWE:** CWE-200
- **Detail:** Header reveals: mw-web.eqiad.main-5fb6d6bf94-xghvb
- **Context:** https response, /
...
- **CWE:** CWE-922
- **Detail:** Response for https://meta.wikimedia.org/ carries Cache-Control: s-maxage=1200, must-revalidate, max-age=0 (plus ETag/Last-Modified freshness fields); shared/shared-CDN caches may store the document (passive cache-poisoning surface).
- **Recommendation:** Use no-store for personalized HTML or verify strict cache keys and Vary headers.

### 13. [INFO] Reverse-DNS (PTR) fingerprint of apex IP (`PTR1`)

- **CWE:** CWE-200
- **Detail:** 103.102.166.224 carries PTR text-lb.eqsin.wikimedia.org. for meta.wikimedia.org.
...
```json
{
  ...
  "mixed_content": [],
  "tech": [
    "Server: mw-web.eqiad.main-5fb6d6bf94-xghvb"
  ],
  "cookies": [
    {},
    {
