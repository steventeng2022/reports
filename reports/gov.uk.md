...
- **CWE:** CWE-1382
- **Detail:** Certificate for gov.uk lists 12 name(s) besides the scope host: *.businesslink.gov.uk, *.cabinet-office.gov.uk, *.direct.gov.uk, *.publishing.service.gov.uk, api.gov.uk, assets.digital.cabinet-office.gov.uk, cabinet-office.gov.uk, data.gov.uk... (1 no longer resolve)

### 2. [INFO] Possible dangling subdomain (`D2`)

- **CWE:** CWE-1382
- **Detail:** Certificate lists `dfid.gov.uk` but it no longer resolves in DNS; stale DNS/CNAME may point at a taken-over service.
