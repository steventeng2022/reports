...
Total findings: **14** (High: 0, Medium: 1, Low: 7, Info: 6)

| # | Severity | ID | Finding | CWE |
|---|---|---|---|---|
| 1 | medium | A3 | GraphQL introspection enabled | CWE-200 |
...
### 1. [MEDIUM] GraphQL introspection enabled (`A3`)

- **CWE:** CWE-200
- **Detail:** Re-verified 2026-09-25: GET https://nydailynews.com/graphql?query={__schema{types{name}}} returns 200 application/json with the full type list (~72KB: Boolean, String, Int, Node, ID, UniformResourceIdentifiable, ...); the schema can be enumerated without authentication.
...
- timing base=714ms id=711 search=468
...
{
  "http_status": 301,
  "http_redirect_to": "https://nydailynews.com/",
  "https_status": 301,
