...
| 12 | info | CT1 | 3 hostnames found via Certificate Transparency (certspotter) | CWE-200 |
...
### 12. [INFO] 3 hostnames found via Certificate Transparency (certspotter) (`CT1`)
...
```json
{
  ...
  "tls": {
    ...
    "subject": "commonName=*.googleadservices.com",
    "issuer": "countryName=US, organizationName=Google Trust Services, commonName=WR2",
    "notBefore": "Sep 10 19:23:06 2026 GMT",
    "notAfter": "Dec  3 19:23:05 2026 GMT",
    "san": [
  ...
  "cors": [
    ...
    {
      "origin": "https://sub.googleadservices.com",
      "acao": "",
      "acac": ""
    }
  ],
