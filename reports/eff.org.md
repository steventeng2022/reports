...
- **CWE:** CWE-200
- **Detail:** TCP connect to 173.239.79.200:22 succeeded (state-only check, no payload sent).
...
- **CWE:** CWE-285
- **Detail:** GET https://mta-sts.eff.org/.well-known/mta-sts/policy.txt failed from this vantage point.
...
- **CWE:** CWE-603
- **Detail:** Certificate of eff.org has no Authority Information Access OCSP entry.
...
```json
{
  ...
  "tls": {
    ...
    "subject": "commonName=eff.org",
    "issuer": "countryName=US, organizationName=Let's Encrypt, commonName=YE1",
    "notBefore": "Sep  1 18:43:26 2026 GMT",
    "notAfter": "Nov 30 18:43:25 2026 GMT",
    "san": [
      "eff.org"
    ],
    "days_left": 64,
