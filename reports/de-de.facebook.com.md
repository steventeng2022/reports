# Security Audit Report — de-de.facebook.com
...
| Listed scope domain | de-de.facebook.com |
...
- **CWE:** CWE-298
- **Detail:** Certificate expires 2026-10-02T23:59:59+00:00 (7 days left) for de-de.facebook.com.

### 2. [INFO] Extra names enumerated from certificate SANs (`D1`)

- **CWE:** CWE-1382
- **Detail:** Certificate for de-de.facebook.com lists 11 name(s) besides the scope host: *.facebook.com, *.facebook.net, *.fbcdn.net, *.fbsbx.com, *.m.facebook.com, *.messenger.com, *.xx.fbcdn.net, *.xy.fbcdn.net...
...
- **CWE:** CWE-200
- **Detail:** No Referrer-Policy header on https://de-de.facebook.com/; full URL (incl. query strings) is sent as referrer by default.

### 6. [INFO] Missing Permissions-Policy (`H7`)

- **CWE:** CWE-200
- **Detail:** No Permissions-Policy header on https://de-de.facebook.com/; browser features (camera, mic, geolocation) unrestricted.

### 7. [INFO] HTTP correctly redirects to HTTPS (`N2`)

- **CWE:** CWE-319
- **Detail:** http://de-de.facebook.com/ -> https://de-de.facebook.com/ (positive check).

### 8. [INFO] robots.txt discloses crawl rules/paths (`R1`)

- **CWE:** CWE-200
- **Detail:** robots.txt on https://de-de.facebook.com/ exposes 44 unique Disallow path(s) (/, /*/plugins/*, /?*next=, /a/bz?, /ajax/)

### 9. [INFO] HTTPS homepage returned HTTP 400 (`X2`)

- **CWE:** CWE-200
- **Detail:** https://de-de.facebook.com/ responded 400 (passive check only; no further probing).
...
- https://de-de.facebook.com/ final status: 400 (final URL https://de-de.facebook.com/).
- http://de-de.facebook.com/ initial status: 301.
