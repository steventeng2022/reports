...
- **CWE:** CWE-603
- **Detail:** Certificate of stats.g.doubleclick.net has no Authority Information Access OCSP entry.
...
```json
{
  ...
  "tls": {
    ...
    "subject": "commonName=*.g.doubleclick.net",
    "issuer": "countryName=US, organizationName=Google Trust Services, commonName=WE2",
    "notBefore": "Sep 10 19:21:59 2026 GMT",
    "notAfter": "Dec  3 19:21:58 2026 GMT",
    "san": [
      "*.g.doubleclick.net",
      "*.invitemedia.com",
      "g.doubleclick.net",
  ...
  "cors": [
    ...
    {
      "origin": "https://sub.stats.g.doubleclick.net",
      "acao": "",
      "acac": ""
    }
  ],
