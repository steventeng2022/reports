...
| 9 | info | CT1 | 36 hostnames found via Certificate Transparency (certspotter) | CWE-200 |
...
### 9. [INFO] 36 hostnames found via Certificate Transparency (certspotter) (`CT1`)
...
```json
{
  ...
  "elapsed_s": 5.7,
  "rechecked": "2026-09-26 16:30 UTC"
}
```
