...
- **CWE:** CWE-614
- **Detail:** Cookie sc_tracking_anonymous_id lacks Secure attribute; transmitted over HTTP.
- **Recommendation:** Add the Secure attribute to the cookie.

### 2. [LOW] Cookie without HttpOnly flag (`C2`)

- **CWE:** CWE-1004
- **Detail:** Cookie sc_tracking_anonymous_id lacks HttpOnly; readable by client-side JS.
...
- **CWE:** CWE-200
- **Detail:** Server header reveals: am/2
...
{
  "http_status": 301,
  "http_redirect_to": "https://soundcloud.com/",
  "https_status": 200,
