...
| 14 | info | RED2 | Soft redirect (302/303) for HTTP to HTTPS | CWE-319 |
| 15 | info | P11 | WordPress login page exposed | CWE-200 |
...
- **CWE:** CWE-200
- **Detail:** TCP connect to 104.20.5.134:8080 succeeded (state-only check, no payload sent).
- **Recommendation:** If the service is not required publicly, close the port or restrict by network.

### 4. [INFO] Alternate web service (port 8443) reachable (`PRT8443`)

- **CWE:** CWE-200
- **Detail:** TCP connect to 104.20.5.134:8443 succeeded (state-only check, no payload sent).
- **Recommendation:** If the service is not required publicly, close the port or restrict by network.
...
### 14. [INFO] Soft redirect (302/303) for HTTP to HTTPS (`RED2`)

- **CWE:** CWE-319
- **Detail:** http:// root answered 302 -> https://creativecommons.org/.
- **Context:** https response, /
- **Recommendation:** Use 301/308 for permanent scheme upgrades.

### 15. [INFO] WordPress login page exposed (`P11`)
...
- **CWE:** CWE-603
- **Detail:** Certificate of creativecommons.org has no Authority Information Access OCSP entry.
...
```json
{
  ...
  "tls": {
    ...
    "subject": "commonName=creativecommons.org",
    "issuer": "countryName=US, organizationName=Google Trust Services, commonName=WE1",
    "notBefore": "Aug 31 19:52:32 2026 GMT",
    "notAfter": "Nov 29 20:52:17 2026 GMT",
    "san": [
      "creativecommons.org",
      "*.creativecommons.org"
    ],
  ...
  "https": {
    ...
    "title": "Building tools for shared knowledge - Creative Commons"
  },
  "mixed_content": [],
  "tech": [
    "Server: cloudflare",
  ...
  "cors": [
    ...
    {
      "origin": "https://sub.creativecommons.org",
      "acao": "",
      "acac": ""
    }
  ],
