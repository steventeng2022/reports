...
- **CWE:** CWE-319
- **Detail:** Location: http://www.google.ca/
- **Context:** https response, /
...
- **CWE:** CWE-603
- **Detail:** Certificate of google.ca has no Authority Information Access OCSP entry.
...
- **CWE:** CWE-922
- **Detail:** Response for https://google.ca/ carries Cache-Control: public, max-age=2592000; shared/shared-CDN caches may store the document (passive cache-poisoning surface).
- **Recommendation:** Use no-store for personalized HTML or verify strict cache keys and Vary headers.

### 16. [INFO] Reverse-DNS (PTR) fingerprint of apex IP (`PTR1`)

- **CWE:** CWE-200
- **Detail:** 142.250.198.67 carries PTR lctsaa-ab-in-f3.1e100.net. for google.ca.
...
```json
{
  ...
  "tls": {
    ...
    "subject": "commonName=*.google.ca",
    "issuer": "countryName=US, organizationName=Google Trust Services, commonName=WR2",
    "notBefore": "Sep 10 19:24:20 2026 GMT",
    "notAfter": "Dec  3 19:24:19 2026 GMT",
    "san": [
      "*.google.ca",
      "google.ca"
    ],
  ...
  "tls2": {
    ...
    "cert": {
      ...
      "aia_ocsp": null,
      "not_before": "20260910192420",
      "not_after": "20261203192419"
    }
  },
  "http2": {
    "robots_disallow": [
