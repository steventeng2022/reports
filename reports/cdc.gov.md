...
- **CWE:** CWE-1004
- **Detail:** Cookie akamai_visit_id lacks HttpOnly; readable by client-side JS.
...
- **CWE:** CWE-1004
- **Detail:** Cookie Akamai-Request-ID lacks HttpOnly; readable by client-side JS.
- **Context:** http response
- **Recommendation:** Add the HttpOnly attribute to the cookie.
...
- **CWE:** CWE-319
- **Detail:** Re-verified: http://cdc.gov/ now returns 301 -> https://cdc.gov/ consistently for browser, security-audit, and curl User-Agents. The 403 observed during the initial audit appears to have been a transient bot-challenge response; the plain-HTTP endpoint currently redirects to HTTPS correctly.
