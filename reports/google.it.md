...
- **CWE:** CWE-319
- **Detail:** Location: http://www.google.it/
- **Context:** https response, /
...
- **CWE:** CWE-603
- **Detail:** Certificate of google.it has no Authority Information Access OCSP entry.
...
- **CWE:** CWE-922
- **Detail:** Response for https://google.it/ carries Cache-Control: public, max-age=2592000; shared/shared-CDN caches may store the document (passive cache-poisoning surface).
- **Recommendation:** Use no-store for personalized HTML or verify strict cache keys and Vary headers.

### 16. [INFO] Reverse-DNS (PTR) fingerprint of apex IP (`PTR1`)

- **CWE:** CWE-200
- **Detail:** 142.250.198.67 carries PTR lctsaa-ab-in-f3.1e100.net. for google.it.
...
```json
{
  ...
  "tls2": {
    ...
    "cert": {
      ...
      "aia_ocsp": null,
      "not_before": "20260910192454",
      "not_after": "20261203192453"
    }
  },
  "http2": {
    "robots_disallow": [
