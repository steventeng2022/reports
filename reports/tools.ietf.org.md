...
| 16 | info | CK5 | Cookie scoped to parent domain (ietf.org) | CWE-200 |
...
- **CWE:** CWE-603
- **Detail:** Certificate of tools.ietf.org has no Authority Information Access OCSP entry.
- **Recommendation:** Enable OCSP (and stapling) so revocation can be checked.

### 16. [INFO] Cookie scoped to parent domain (ietf.org) (`CK5`)

- **CWE:** CWE-200
- **Detail:** Set-Cookie Domain attribute is broader than the request host tools.ietf.org.
...
```json
{
  ...
  "tls": {
    ...
    "subject": "commonName=*.tools.ietf.org",
    "issuer": "countryName=US, organizationName=Let's Encrypt, commonName=YE2",
    "notBefore": "Sep  5 07:01:32 2026 GMT",
    "notAfter": "Dec  4 07:01:31 2026 GMT",
    "san": [
      "*.tools.ietf.org",
      "tools.ietf.org"
    ],
  ...
  "cors": [
    ...
    {
      "origin": "https://sub.tools.ietf.org",
      "acao": "",
      "acac": ""
    }
  ],
  "http": {
    "status": 301,
    "location": "https://authors.ietf.org/"
  },
  "redir_probes": [
