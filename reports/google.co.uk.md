# Security Audit Report — google.co.uk
...
- **CWE:** CWE-1004
- **Detail:** Set on https://google.co.uk/ without HttpOnly: SEARCH_SAMESITE, __Secure-STRP. Readable by client-side script.

### 2. [LOW] Cookies set without Secure flag (`C2`)

- **CWE:** CWE-614
- **Detail:** Set on https://google.co.uk/ without Secure: SEARCH_SAMESITE. Will be transmitted over HTTP if the site is reachable cleartext.

### 3. [LOW] Cookies set without SameSite Lax/Strict (`C3`)

- **CWE:** CWE-1004
- **Detail:** Set on https://google.co.uk/ without SameSite=Lax/Strict: NID. Cross-site request cookies.

### 4. [LOW] Missing Content-Security-Policy (`H3`)

- **CWE:** CWE-79
- **Detail:** No CSP header on https://google.co.uk/; no defense-in-depth against XSS/content injection.

### 5. [LOW] Missing X-Content-Type-Options: nosniff (`H4`)

- **CWE:** CWE-693
- **Detail:** No X-Content-Type-Options header on https://google.co.uk/; browsers may MIME-sniff responses.

### 6. [INFO] Cookies scoped to parent/wildcard domain (`C4`)

- **CWE:** CWE-200
- **Detail:** Cookies set with domain beyond google.co.uk: .google.com.

### 7. [INFO] Extra names enumerated from certificate SANs (`D1`)

- **CWE:** CWE-1382
- **Detail:** Certificate for google.co.uk lists 1 name(s) besides the scope host: *.google.co.uk
...
- **CWE:** CWE-200
- **Detail:** No Referrer-Policy header on https://google.co.uk/; full URL (incl. query strings) is sent as referrer by default.

### 11. [INFO] sitemap.xml discloses URL inventory (`M1`)

- **CWE:** CWE-200
- **Detail:** sitemap.xml on https://google.co.uk/ lists 22 URLs.

### 12. [INFO] robots.txt discloses crawl rules/paths (`R1`)

- **CWE:** CWE-200
- **Detail:** robots.txt on https://google.co.uk/ exposes 174 unique Disallow path(s) (/?, /?hl=*&, /?hl=*&*&gws_rd=ssl, /about/careers/applications-a/jobs/results, /about/careers/applications/candidate-prep) and 1 sitemap reference(s)

### 13. [INFO] security.txt exposed (public disclosure policy) (`S2`)

- **CWE:** CWE-200
- **Detail:** security.txt present on https://google.co.uk (275 bytes); contact: https://g.co/vulnz

### 14. [INFO] HTTPS root redirects to different host (`X3`)

- **CWE:** CWE-200
- **Detail:** https://google.co.uk/ redirects to https://www.google.com/.

## Reproduction notes

- Scanned 2026-09-25 19:34 UTC from Asia/Taipei (UTC+8); passive GET/TLS/DNS only; no payloads injected into request parameters; single pass per endpoint; no authenticated sessions.
- https://google.co.uk/ final status: 200 (final URL https://www.google.com/).
- http://google.co.uk/ initial status: 301.
- Certificate: Google Trust Services WR2, valid until 2026-12-03T19:24:27+00:00.

## Active agent cross-check (wave 10 aggressive scan on main - google.co.uk)
