...
- **CWE:** CWE-319
- **Detail:** Location: http://www.google.nl/
- **Context:** https response, /
...
- **CWE:** CWE-603
- **Detail:** Certificate of google.nl has no Authority Information Access OCSP entry.
...
- **CWE:** CWE-922
- **Detail:** Response for https://google.nl/ carries Cache-Control: public, max-age=2592000; shared/shared-CDN caches may store the document (passive cache-poisoning surface).
...
```json
{
  ...
  "tls": {
    ...
    "subject": "commonName=*.google.nl",
    "issuer": "countryName=US, organizationName=Google Trust Services, commonName=WR2",
    "notBefore": "Sep 10 19:25:02 2026 GMT",
    "notAfter": "Dec  3 19:25:01 2026 GMT",
    "san": [
      "*.google.nl",
      "google.nl"
    ],
  ...
  "tls2": {
    ...
    "cert": {
      ...
      "aia_ocsp": null,
      "not_before": "20260910192502",
      "not_after": "20261203192501"
    }
  },
  "http2": {
    "robots_disallow": [
