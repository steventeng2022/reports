...
| 13 | info | CORS4 | CORS: wildcard Access-Control-Allow-Origin | CWE-942 |
| 14 | info | CORS2 | CORS: subdomain origin origin accepted (no credentials) | CWE-942 |
...
### 13. [INFO] CORS: wildcard Access-Control-Allow-Origin (`CORS4`)
...
### 14. [INFO] CORS: subdomain origin origin accepted (no credentials) (`CORS2`)
...
```json
{
  ...
  "http": {
    "status": 301,
    "location": "https://cdn.shopify.com/"
  },
  "redir_probes": [
