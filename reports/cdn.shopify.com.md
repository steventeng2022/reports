...
- **CWE:** CWE-200
- **Detail:** TCP connect to 23.227.39.200:8080 succeeded (state-only check, no payload sent).
- **Recommendation:** If the service is not required publicly, close the port or restrict by network.

### 3. [INFO] Alternate web service (port 8443) reachable (`PRT8443`)

- **CWE:** CWE-200
- **Detail:** TCP connect to 23.227.39.200:8443 succeeded (state-only check, no payload sent).
- **Recommendation:** If the service is not required publicly, close the port or restrict by network.
...
- **CWE:** CWE-200
- **Detail:** Alt-Svc: h3=":443"; ma=2592000, h3=":443"; ma=2592000
...
- **CWE:** CWE-942
- **Detail:** Origin https://sub.cdn.shopify.com was echoed in Access-Control-Allow-Origin.
- **Context:** https response, /
...
- **CWE:** CWE-603
- **Detail:** Certificate of cdn.shopify.com has no Authority Information Access OCSP entry.
- **Recommendation:** Enable OCSP (and stapling) so revocation can be checked.

### 16. [INFO] HSTS present but domain not in the HSTS preload list (`HSTSP`)

- **CWE:** CWE-319
- **Detail:** Strict-Transport-Security is served but cdn.shopify.com is not listed in the HSTS preload list.
- **Recommendation:** Submit the domain to the HSTS preload list (requires includeSubDomains + long max-age).

### 17. [INFO] robots.txt discloses disallowed paths (asset map) (`ROB1`)

- **CWE:** CWE-200
- **Detail:** robots.txt lists 2 disallow path(s), e.g. */blog-article-remove-faq-utms-*.js, /wpm/*.js
- **Recommendation:** Review disallowed paths; robots is not access control.

### 18. [INFO] HTML document served with cacheable freshness headers (`CCH1`)

- **CWE:** CWE-922
- **Detail:** Response for https://cdn.shopify.com/ carries Cache-Control: max-age=3600, public; shared/shared-CDN caches may store the document (passive cache-poisoning surface).
...
```json
{
  ...
  "tls": {
    ...
    "subject": "commonName=cdn.shopify.com",
    "issuer": "countryName=US, organizationName=Google Trust Services, commonName=WE1",
    "notBefore": "Aug  8 00:46:45 2026 GMT",
    "notAfter": "Nov  6 01:46:39 2026 GMT",
    "san": [
      "cdn.shopify.com"
    ],
    "days_left": 40,
  ...
  "cors": [
    ...
    {
      "origin": "https://sub.cdn.shopify.com",
      "acao": "*",
      "acac": ""
    }
  ],
  "http": {
    "status": 301,
    "location": "https://cdn.shopify.com:443/"
  },
  "redir_probes": [
  ...
  "tls2": {
    ...
    "cert": {
      ...
      "aia_ocsp": null,
      "not_before": "20260808004645",
      "not_after": "20261106014639"
    }
  },
  "http2": {
    "robots_disallow": [
