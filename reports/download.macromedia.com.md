...
- **CWE:** CWE-319
- **Detail:** http:// root answered 302 -> http://www.adobe.com/shockwave/download/.
- **Context:** https response, /
...
- **CWE:** CWE-319
- **Detail:** Location: http://www.adobe.com/shockwave/download/
- **Context:** https response, /
...
```json
{
  "domain": "download.macromedia.com",
  "dns": {
    "a": [
      "184.24.89.127"
    ],
  ...
  "tls": {
    ...
    "subject": "countryName=US, stateOrProvinceName=California, localityName=San Jose, organizationName=Adobe Inc., commonName=fpdownload.macromedia.com",
  ...
  "cors": [
    ...
    {
      "origin": "https://sub.download.macromedia.com",
      "acao": "",
      "acac": ""
    }
  ],
  "http": {
    "status": 302,
    "location": "http://www.adobe.com/shockwave/download/"
  },
  "redir_probes": [
