...
- **CWE:** CWE-1382
- **Detail:** Certificate for logitech.com lists 14 name(s) besides the scope host: *.logicool.co.jp, *.logitech.com, *.logitech.com.cn, *.logitech.fr, *.logitechg.com, *.logitechg.com.cn, *.logitechg.fr, logicool.co.jp... (4 no longer resolve)

### 3. [INFO] Possible dangling subdomain (`D2`)

- **CWE:** CWE-1382
- **Detail:** Certificate lists `logicool.co.jp` but it no longer resolves in DNS; stale DNS/CNAME may point at a taken-over service.

### 4. [INFO] Possible dangling subdomain (`D2`)

- **CWE:** CWE-1382
- **Detail:** Certificate lists `logitech.ch` but it no longer resolves in DNS; stale DNS/CNAME may point at a taken-over service.

### 5. [INFO] Possible dangling subdomain (`D2`)

- **CWE:** CWE-1382
- **Detail:** Certificate lists `logitech.fr` but it no longer resolves in DNS; stale DNS/CNAME may point at a taken-over service.
