...
| 14 | info | R1 | HTTP redirect chain ends at HTTPS with HSTS | CWE-319 |
...
- **CWE:** CWE-538
- **Detail:** Paths answering 401/403 or HTML shells: /.svn/entries (403 protected), /package.json (403 protected), /.aws/credentials (403 protected).
...
### 14. [INFO] HTTP redirect chain ends at HTTPS with HSTS (`R1`)

- **CWE:** CWE-319
- **Detail:** http://stats.wp.com -> 301 http://wordpress.com/ -> 301 https://wordpress.com/ -> 200 with Strict-Transport-Security max-age=31536000; preload. The initial hop is plain HTTP but the chain terminates at HTTPS with HSTS preload.
...
- sweep: {"high":[],"protected":["/.svn/entries (403 protected)","/package.json (403 protected)","/.aws/credentials (403 protected)"]}
- robots_disallow: ["/"]

Stage-2 probe log (observed responses):
- timing base=431ms id=905 search=309
...
{
  "http_status": 301,
  "http_redirect_to": "http://wordpress.com/",
  "https_status": 301,
