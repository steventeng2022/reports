...
- **CWE:** CWE-319
- **Detail:** Location: http://www.google.co.za/
- **Context:** https response, /
...
- **CWE:** CWE-603
- **Detail:** Certificate of google.co.za has no Authority Information Access OCSP entry.
...
- **CWE:** CWE-922
- **Detail:** Response for https://google.co.za/ carries Cache-Control: public, max-age=2592000; shared/shared-CDN caches may store the document (passive cache-poisoning surface).
- **Recommendation:** Use no-store for personalized HTML or verify strict cache keys and Vary headers.

### 16. [INFO] Reverse-DNS (PTR) fingerprint of apex IP (`PTR1`)

- **CWE:** CWE-200
- **Detail:** 142.250.77.195 carries PTR del11s08-in-f3.1e100.net., lctsaa-ah-in-f3.1e100.net. for google.co.za.
...
```json
{
  ...
  "tls": {
    ...
    "subject": "commonName=*.google.co.za",
  ...
  "http": {
    "status": 301,
    "location": "http://www.google.co.za/"
  },
  "redir_probes": [
  ...
  "tls2": {
    ...
    "cert": {
      ...
      "aia_ocsp": null,
      "not_before": "20260910192428",
      "not_after": "20261203192427"
    }
  },
  "http2": {
    "robots_disallow": [
