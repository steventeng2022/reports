...
- **CWE:** CWE-1004
- **Detail:** Set on https://linkedin.com/ without HttpOnly: JSESSIONID, bcookie, lang, lidc, sdui_ver. Readable by client-side script.

### 2. [LOW] Cookies set without Secure flag (`C2`)

- **CWE:** CWE-614
- **Detail:** Set on https://linkedin.com/ without Secure: sdui_ver. Will be transmitted over HTTP if the site is reachable cleartext.

### 3. [LOW] Cookies set without SameSite Lax/Strict (`C3`)

- **CWE:** CWE-1004
- **Detail:** Set on https://linkedin.com/ without SameSite=Lax/Strict: JSESSIONID, __cf_bm, bcookie, bscookie, lang, lidc, sdui_ver. Cross-site request cookies.
