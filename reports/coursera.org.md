...
- **CWE:** CWE-614
- **Detail:** Cookie __204u lacks Secure attribute; transmitted over HTTP.
- **Recommendation:** Add the Secure attribute to the cookie.

### 2. [LOW] Cookie without HttpOnly flag (`C2`)

- **CWE:** CWE-1004
- **Detail:** Cookie CSRF3-Token lacks HttpOnly; readable by client-side JS.
- **Recommendation:** Add the HttpOnly attribute to the cookie.

### 3. [LOW] Cookie without HttpOnly flag (`C2`)

- **CWE:** CWE-1004
- **Detail:** Cookie __204u lacks HttpOnly; readable by client-side JS.
- **Recommendation:** Add the HttpOnly attribute to the cookie.
...
{
  "http_status": 301,
  "http_redirect_to": "https://coursera.org/",
  "https_status": 301,
  "content_type": "",
  "title": "",
  "path_gitconfig": 301,
