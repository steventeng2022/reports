...
| Test date | 2026-09-24 19:40 UTC |
| Method | Non-destructive passive/active probing (GET requests only, no forms submitted, no auth) |

## Summary

Total findings: **16** (High: 0, Medium: 1, Low: 8, Info: 7)
...
- **CWE:** CWE-319
- **Detail:** http://hkrsa.asia returns 200 without redirecting to HTTPS. No Strict-Transport-Security observed on the HTTPS response.
...
- **CWE:** CWE-538
- **Detail:** Paths answering 401/403 or HTML shells: /server-status (403 protected), /wp-login.php (HTML shell).
...
- **CWE:** CWE-200
- **Detail:** Server header reveals: Apache/2
- **Context:** http response
...
- **CWE:** CWE-200
- **Detail:** X-Powered-By: PHP/7.4.22
...
- sweep: {"high":[],"protected":["/server-status (403 protected)","/wp-login.php (HTML shell)"]}
- robots_disallow: ["Sitemap:"]

Stage-2 probe log (observed responses):
- timing base=3512ms id=3858 search=3118
- boolean b=200/176358 t1=301/0 t2=301/0
- graphql /graphql -> 404
...
**Stage 3 - live parameter harvest, takeover and injection probes (40 requests):**

- params_harvested: ["ver","rsd","url","id","ev","noscript"]

Stage-3 probe log (observed responses):
- harvest discovered 6 live query params
- xss3 https://hkrsa.asia/wp-includes/js/jquery/jquery.min.js?ver -> err
- xss3 https://hkrsa.asia/xmlrpc.php?rsd -> err
- xss3 https://hkrsa.asia/wp-json/oembed/1.0/embed?url -> err
- xss3 https://www.googletagmanager.com/ns.html?id -> err
- xss3 https://www.facebook.com/tr?ev -> err
- xss3 https://www.facebook.com/tr?noscript -> err
...
```json
{
  ...
  "title": "主頁 - 香港專業花式跳繩學校 Hong Kong Rope Skipping Academy",
  "path_gitconfig": 404,
  "path_envfile": 404,
