...
- **CWE:** CWE-319
- **Detail:** Location: http://www.google.se/
- **Context:** https response, /
...
- **CWE:** CWE-603
- **Detail:** Certificate of google.se has no Authority Information Access OCSP entry.
...
- **CWE:** CWE-922
- **Detail:** Response for https://google.se/ carries Cache-Control: public, max-age=2592000; shared/shared-CDN caches may store the document (passive cache-poisoning surface).
- **Recommendation:** Use no-store for personalized HTML or verify strict cache keys and Vary headers.

### 16. [INFO] Reverse-DNS (PTR) fingerprint of apex IP (`PTR1`)

- **CWE:** CWE-200
- **Detail:** 142.250.204.35 carries PTR hkg07s38-in-f3.1e100.net., lctsaa-ac-in-f3.1e100.net. for google.se.
...
```json
{
  ...
  "tls": {
    ...
    "subject": "commonName=*.google.se",
    "issuer": "countryName=US, organizationName=Google Trust Services, commonName=WR2",
    "notBefore": "Sep 10 19:25:05 2026 GMT",
    "notAfter": "Dec  3 19:25:04 2026 GMT",
    "san": [
      "*.google.se",
      "google.se"
    ],
  ...
  "tls2": {
    ...
    "cert": {
      ...
      "aia_ocsp": null,
      "not_before": "20260910192505",
      "not_after": "20261203192504"
    }
  },
  "http2": {
    "robots_disallow": [
