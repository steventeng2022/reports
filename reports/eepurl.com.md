...
```json
{
  ...
  "tls": {
    ...
    "subject": "countryName=US, stateOrProvinceName=California, localityName=San Diego, organizationName=Intuit Inc., commonName=wildcardsan2.mailchimp.com",
    ...
    "san": [
      ...
      "*.partner-api.mailchimp.com",
      "*.partners.mailchimp.com",
      "*.vip-reports.net",
      "chimpstatic.com",
      "e2e.eepurl.com",
      "eep.io",
