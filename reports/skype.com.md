...
- **CWE:** CWE-1382
- **Detail:** Certificate for skype.com lists 171 name(s) besides the scope host: *.microsoft.ch, *.microsoftedge.com, ageofmythology.com, ambitions.microsoft.fr, asp.net, batchaitraining.azure.com, bingplaces.com, businesscentral.be... (3 no longer resolve)
...
- **CWE:** CWE-1382
- **Detail:** Certificate lists `www.dynamics365businesscentral.co.nz` but it no longer resolves in DNS; stale DNS/CNAME may point at a taken-over service.
