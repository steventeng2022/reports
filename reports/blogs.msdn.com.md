...
- **CWE:** CWE-319
- **Detail:** http:// root answered 302 -> https://blogs.msdn.com/.
- **Context:** https response, /
...
- **CWE:** CWE-319
- **Detail:** Strict-Transport-Security is served but blogs.msdn.com is not listed in the HSTS preload list.
...
```json
{
  ...
  "tls": {
    ...
    "subject": "countryName=US, stateOrProvinceName=WA, localityName=Redmond, organizationName=Microsoft Corporation, commonName=blogs.msdn.com",
    "issuer": "countryName=US, organizationName=Microsoft Corporation, commonName=Microsoft TLS G2 RSA CA OCSP 10",
    "notBefore": "Aug 29 09:22:35 2026 GMT",
    "notAfter": "Feb 25 09:22:35 2027 GMT",
    "san": [
      "blogs.msdn.com"
    ],
    "days_left": 151,
  ...
  "cors": [
    ...
    {
      "origin": "https://sub.blogs.msdn.com",
      "acao": "",
      "acac": ""
    }
  ],
