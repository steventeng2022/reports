...
- **CWE:** CWE-1038
- **Detail:** GET https://business.facebook.com/.env returns 200. Verified: response body is the application HTML SPA fallback (Content-Type: text/html), not the raw file. Informational observation, no data exposed.
...
{
  "http_status": 301,
  "http_redirect_to": "https://business.facebook.com/",
  "https_status": 302,
