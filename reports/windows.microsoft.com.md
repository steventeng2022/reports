...
```json
{
  ...
  "dns": {
    ...
    "aaaa": [],
    "cname": "windows.microsoft.com.edgekey.net.",
    "mx": [],
    "ns": [],
    "spf": [],
    "dmarc": [],
  ...
  "tls": {
    ...
    "subject": "countryName=US, stateOrProvinceName=WA, localityName=Redmond, organizationName=Microsoft Corporation, commonName=s-res.s.windows.microsoft.com",
    "issuer": "countryName=US, organizationName=Microsoft Corporation, commonName=Microsoft TLS G2 RSA CA OCSP 16",
    "notBefore": "Jan 22 20:57:08 2026 GMT",
    "notAfter": "Jan 17 20:57:08 2027 GMT",
    "san": [
  ...
  "cors": [
    ...
    {
      "origin": "https://sub.windows.microsoft.com",
      "acao": "",
      "acac": ""
    }
  ],
  "http": {
    "status": 301,
    "location": "https://go.microsoft.com/fwlink/p/?linkid=532428"
  },
  "redir_probes": [
