...
| 14 | low | RED9 | Redirect chain of 5+ hops on the site root | CWE-601 |
...
- **CWE:** CWE-319
- **Detail:** http:// root answered 302 -> https://mail.google.com/chat.
- **Context:** https response, /
...
- **CWE:** CWE-603
- **Detail:** Certificate of hangouts.google.com has no Authority Information Access OCSP entry.
- **Recommendation:** Enable OCSP (and stapling) so revocation can be checked.

### 14. [LOW] Redirect chain of 5+ hops on the site root (`RED9`)

- **CWE:** CWE-601
- **Detail:** Following https://hangouts.google.com/ produced 5 redirect hops.
...
- **CWE:** CWE-200
- **Detail:** 142.250.196.206 carries PTR nctsaa-ac-in-f14.1e100.net. for hangouts.google.com.
...
```json
{
  ...
  "cors": [
    ...
    {
      "origin": "https://sub.hangouts.google.com",
      "acao": "",
      "acac": ""
    }
  ],
  "http": {
    "status": 302,
    "location": "https://mail.google.com/chat"
  },
  "redir_probes": [
