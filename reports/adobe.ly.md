...
- **CWE:** CWE-200
- **Detail:** Original observation: GET https://adobe.ly/ with Host: evil-host.example echoed the Host value in the body. Re-verified 2026-09-25: https 301 (55-byte body, no echo); http 302 -> https://adobe.ly/ (40-byte body, no echo). Not reproduced on re-verify.
...
- timing base=208ms id=214 search=211
- boolean b=301/55 t1=301/55 t2=301/55
- graphql /graphql -> 302
...
{
  "http_status": 302,
  "http_redirect_to": "https://adobe.ly/",
  "https_status": 301,
