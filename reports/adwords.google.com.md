...
- **CWE:** CWE-1382
- **Detail:** Certificate for adwords.google.com lists 120 name(s) besides the scope host: *.admob.biz, *.admob.co.in, *.admob.co.kr, *.admob.co.nz, *.admob.co.uk, *.admob.co.za, *.admob.com, *.admob.com.br... (1 no longer resolve)
...
- **CWE:** CWE-200
- **Detail:** No Referrer-Policy header on https://adwords.google.com/; full URL (incl. query strings) is sent as referrer by default.

### 6. [INFO] HTTP correctly redirects to HTTPS (`N2`)

- **CWE:** CWE-319
- **Detail:** http://adwords.google.com/ -> https://adwords.google.com/ (positive check).

### 7. [INFO] robots.txt discloses crawl rules/paths (`R1`)

- **CWE:** CWE-200
- **Detail:** robots.txt on https://adwords.google.com/ exposes 4 unique Disallow path(s) (/, /api, /api*?hl=, /um/*)

### 8. [INFO] No security.txt (no public vulnerability disclosure policy) (`S1`)

- **CWE:** CWE-200
- **Detail:** GET /.well-known/security.txt returned 404 on adwords.google.com.

### 9. [INFO] HTTPS root redirects to different host (`X3`)

- **CWE:** CWE-200
- **Detail:** https://adwords.google.com/ redirects to https://business.google.com/tw/google-ads/.
...
- https://adwords.google.com/ final status: 200 (final URL https://business.google.com/tw/google-ads/).
- http://adwords.google.com/ initial status: 301.
