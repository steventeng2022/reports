...
| Test date | 2026-09-24 22:02 UTC |
...
- **CWE:** CWE-319
- **Detail:** http://maps.gstatic.com returns 404 without redirecting to HTTPS; no HSTS observed on the HTTPS response (404).
...
- **CWE:** CWE-200
- **Detail:** Disallowed paths in robots.txt: /urchin_test/, /jsapi, /transconsole/portal/, /squared/api.
...
- robots_disallow: ["/search","/groups","/images","/catalogs","/catalogues","/news","/nwshp","/setnewsprefs?","/index.html?","/?","/addurl/image?","/pagead/","/relpage/","/relcontent","/imgres","/imglanding","/keyword/","/u/","/univ/","/cobrand"]

Stage-2 probe log (observed responses):
- timing base=70ms id=25 search=14
