...
- **CWE:** CWE-942
- **Detail:** Origin https://sub.pbs.twimg.com was echoed in Access-Control-Allow-Origin.
- **Context:** https response, /
...
- **CWE:** CWE-603
- **Detail:** Certificate of pbs.twimg.com has no Authority Information Access OCSP entry.
- **Recommendation:** Enable OCSP (and stapling) so revocation can be checked.

### 10. [INFO] HSTS present but domain not in the HSTS preload list (`HSTSP`)

- **CWE:** CWE-319
- **Detail:** Strict-Transport-Security is served but pbs.twimg.com is not listed in the HSTS preload list.
...
```json
{
  ...
  "dns": {
    ...
    "aaaa": [],
    "cname": "dualstack.twimg.twitter.map.fastly.net.",
    "mx": [],
    "ns": [],
    "spf": [],
    "dmarc": [],
  ...
  "tls": {
    ...
    "subject": "commonName=*.twimg.com",
    "issuer": "countryName=US, organizationName=Let's Encrypt, commonName=YR2",
    "notBefore": "Sep 15 20:20:31 2026 GMT",
    "notAfter": "Dec 14 20:20:30 2026 GMT",
    "san": [
      "*.twimg.com",
  ...
  "cors": [
    ...
    {
      "origin": "https://sub.pbs.twimg.com",
      "acao": "https://sub.pbs.twimg.com",
      "acac": ""
    }
  ],
  "http": {
  ...
  "tls2": {
    ...
    "cert": {
      ...
      "aia_ocsp": null,
      "not_before": "20260915202031",
      "not_after": "20261214202030"
    }
  },
  "x12": {
    "status": 400
