...
- **CWE:** CWE-200
- **Detail:** robots.txt on https://pinterest.com/ exposes 218 unique Disallow path(s) (/, /*/*/*/_tools/*, /*/*/*/more_ideas/, /*/*/_tools/*, /*/*/activity/*) and 101 sitemap reference(s)

### 9. [INFO] security.txt exposed (public disclosure policy) (`S2`)

- **CWE:** CWE-200
- **Detail:** security.txt present on https://pinterest.com (308664 bytes)
