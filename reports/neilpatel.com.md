# Security Audit Report - neilpatel.com
...
| Test date | 2026-09-24 22:05 UTC |
...
| 12 | info | H7 | X-Powered-By disclosure | CWE-200 |
...
- **CWE:** CWE-200
- **Detail:** Disallowed paths in robots.txt: /wp-content/themes/neilpatel/js/script-comments.js, /wp-comments-post.php, /wp-admin/, /wp-login.php.
...
- **CWE:** CWE-538
- **Detail:** Paths answering 401/403 or HTML shells: /.svn/entries (403 protected), /swagger-ui.html (403 protected), /swagger.json (403 protected), /openapi.json (403 protected), /wp-login.php (403 protected), /backup.zip (403 protected), /config.yml (403 protected), /elm.json (403 protected), /package.json (403 protected), /.aws/credentials (403 protected).
...
### 12. [INFO] X-Powered-By disclosure (`H7`)
...
- sweep: {"high":[],"protected":["/.svn/entries (403 protected)","/swagger-ui.html (403 protected)","/swagger.json (403 protected)","/openapi.json (403 protected)","/wp-login.php (403 protected)","/backup.zip (403 protected)","/config.yml (403 protected)","/elm.json (403 protected)","/package.json (403 protected)","/.aws/credentials (403 protected)"]}
- robots_disallow: ["/*?comments","/wp-content/themes/neilpatel/js/script-comments.js","/wp-comments-post.php","/wp-admin/","/wp-login.php","/go/","/tag/","/author/","/cdn-cgi/","/*/feed/","/*/comments/","/*?s=","/*?p=","/license.txt","/","/"]

Stage-2 probe log (observed responses):
- timing base=50ms id=49 search=34
- boolean b=403/5732 t1=403/5777 t2=403/5777
- graphql /graphql -> 301
...
{
  "http_status": 301,
  "http_redirect_to": "https://neilpatel.com/",
  "https_status": 200,
  ...
  "robots_disallow": [
    "/*?comments",
    "/wp-content/themes/neilpatel/js/script-comments.js",
