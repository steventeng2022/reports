...
- **CWE:** CWE-319
- **Detail:** Location: http://www.google.com.br/
- **Context:** https response, /
...
- **CWE:** CWE-603
- **Detail:** Certificate of google.com.br has no Authority Information Access OCSP entry.
...
- **CWE:** CWE-922
- **Detail:** Response for https://google.com.br/ carries Cache-Control: public, max-age=2592000; shared/shared-CDN caches may store the document (passive cache-poisoning surface).
- **Recommendation:** Use no-store for personalized HTML or verify strict cache keys and Vary headers.

### 16. [INFO] Reverse-DNS (PTR) fingerprint of apex IP (`PTR1`)

- **CWE:** CWE-200
- **Detail:** 108.177.125.94 carries PTR tp-in-f94.1e100.net. for google.com.br.
...
```json
{
  ...
  "tls": {
    ...
    "subject": "commonName=*.google.com.br",
    "issuer": "countryName=US, organizationName=Google Trust Services, commonName=WE2",
    "notBefore": "Sep 10 19:24:37 2026 GMT",
    "notAfter": "Dec  3 19:24:36 2026 GMT",
    "san": [
      "*.google.com.br",
      "google.com.br"
    ],
  ...
  "cors": [
    ...
    {
      "origin": "https://sub.google.com.br",
      "acao": "",
      "acac": ""
    }
  ],
  ...
  "tls2": {
    ...
    "cert": {
      ...
      "aia_ocsp": null,
      "not_before": "20260910192437",
      "not_after": "20261203192436"
    }
  },
  "http2": {
    "robots_disallow": [
