...
- **CWE:** CWE-200
- **Detail:** TCP connect to 104.17.24.14:8080 succeeded (state-only check, no payload sent).
- **Recommendation:** If the service is not required publicly, close the port or restrict by network.

### 3. [INFO] Alternate web service (port 8443) reachable (`PRT8443`)

- **CWE:** CWE-200
- **Detail:** TCP connect to 104.17.24.14:8443 succeeded (state-only check, no payload sent).
- **Recommendation:** If the service is not required publicly, close the port or restrict by network.
...
- **CWE:** CWE-603
- **Detail:** Certificate of cdnjs.cloudflare.com has no Authority Information Access OCSP entry.
...
```json
{
  ...
  "tls": {
    ...
    "subject": "commonName=cdnjs.cloudflare.com",
    "issuer": "countryName=US, organizationName=Google Trust Services, commonName=WE1",
    "notBefore": "Sep  7 14:43:48 2026 GMT",
    "notAfter": "Dec  6 15:43:45 2026 GMT",
    "san": [
  ...
  "cors": [
    ...
    {
      "origin": "https://sub.cdnjs.cloudflare.com",
      "acao": "",
      "acac": ""
    }
  ],
  ...
  "redir_probes": [
    "/redirect?url=https://evil-auditor.example/x -> 522",
    "/redirect?next=https://evil-auditor.example/x -> 522",
    "/go?url=https://evil-auditor.example/x -> 522",
    "/url?url=https://evil-auditor.example/x -> 522"
  ],
  "paths": {
    "/robots.txt": 522,
    "/sitemap.xml": 522,
    "/.well-known/security.txt": 522,
    "/security.txt": 522,
    "/.git/HEAD": 522,
    "/.git/config": 522,
    "/.env": 522,
