...
- **CWE:** CWE-319
- **Detail:** No Strict-Transport-Security header on https://webroot.com/. Clients may connect over plain HTTP on first visit.

### 5. [LOW] Missing Content-Security-Policy (`H3`)

- **CWE:** CWE-79
- **Detail:** No CSP header on https://webroot.com/; no defense-in-depth against XSS/content injection.
...
- **CWE:** CWE-1021
- **Detail:** No X-Frame-Options and no CSP frame-ancestors on https://webroot.com/; page may be rendered in a foreign frame.
...
- **CWE:** CWE-200
- **Detail:** https://webroot.com/ responded 403 (passive check only; no further probing).
...
- https://webroot.com/ final status: 403 (final URL https://www.webroot.com/).
