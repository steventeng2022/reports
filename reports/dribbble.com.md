...
| 4 | low | X1 | CORS wildcard on 202 bot-challenge response | CWE-942 |
...
### 4. [LOW] CORS wildcard on 202 bot-challenge response (`X1`)

- **CWE:** CWE-942
- **Detail:** https://dribbble.com/ returns 202 (JS-challenge response) with Access-Control-Allow-Origin: *, while real 200 pages such as /shots set no ACAO header. The wildcard is limited to the challenge response, not normal content.
...
{
  "http_status": 301,
  "http_redirect_to": "https://dribbble.com/",
  "https_status": 202,
