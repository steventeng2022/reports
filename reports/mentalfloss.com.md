...
| 13 | info | I5 | Open redirect candidate refuted (404 on www hop) | CWE-601 |
...
- **CWE:** CWE-200
- **Detail:** Server header reveals: redirector-service
- **Context:** http response
...
### 13. [INFO] Open redirect candidate refuted (404 on www hop) (`I5`)

- **CWE:** CWE-601
- **Detail:** https://mentalfloss.com/redirect?url=301s to the www host, which returns 404; the parameter is not followed.
...
{
  "http_status": 301,
  "http_redirect_to": "https://www.mentalfloss.com/",
  "https_status": 301,
  "content_type": "",
  "title": "",
  "path_gitconfig": 301,
  ...
  "open_redirect": {
    ...
    "location": "https://www.mentalfloss.com/redirect?url=https%3A%2F%2Fevil-cors.example%2Fx"
  }
}
```
