...
- **CWE:** CWE-319
- **Detail:** http:// root answered 302 -> https://ad.doubleclick.net/.
- **Context:** https response, /
...
- **CWE:** CWE-603
- **Detail:** Certificate of ad.doubleclick.net has no Authority Information Access OCSP entry.
...
- **CWE:** CWE-922
- **Detail:** Response for https://ad.doubleclick.net/ carries Cache-Control: public, max-age=1800; shared/shared-CDN caches may store the document (passive cache-poisoning surface).
- **Recommendation:** Use no-store for personalized HTML or verify strict cache keys and Vary headers.

### 16. [INFO] Reverse-DNS (PTR) fingerprint of apex IP (`PTR1`)

- **CWE:** CWE-200
- **Detail:** 142.250.196.198 carries PTR nctsaa-ac-in-f6.1e100.net. for ad.doubleclick.net.
...
```json
{
  ...
  "tls": {
    ...
    "subject": "commonName=*.doubleclick.net",
  ...
  "cors": [
    ...
    {
      "origin": "https://sub.ad.doubleclick.net",
      "acao": "",
      "acac": ""
    }
  ],
