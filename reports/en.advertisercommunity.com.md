...
- **CWE:** CWE-200
- **Detail:** Detected: Server: support-content-ui
...
- **CWE:** CWE-200
- **Detail:** Header reveals: support-content-ui
- **Context:** https response, /
...
- **CWE:** CWE-200
- **Detail:** Apex TXT records with verification/token content: facebook-domain-verification=t8b7bl46eixt2ruofa08cd33sos8ts
- **Recommendation:** Review published verification records; they confirm domain ownership to third parties.

### 12. [INFO] No OCSP responder URL in certificate (no stapling possible) (`OCSP3`)

- **CWE:** CWE-603
- **Detail:** Certificate of en.advertisercommunity.com has no Authority Information Access OCSP entry.
...
- **CWE:** CWE-922
- **Detail:** Response for https://en.advertisercommunity.com/ carries Cache-Control: public, max-age=2592000; shared/shared-CDN caches may store the document (passive cache-poisoning surface).
- **Recommendation:** Use no-store for personalized HTML or verify strict cache keys and Vary headers.

### 15. [INFO] Reverse-DNS (PTR) fingerprint of apex IP (`PTR1`)

- **CWE:** CWE-200
- **Detail:** 142.250.198.78 carries PTR lctsaa-ab-in-f14.1e100.net. for en.advertisercommunity.com.
...
```json
{
  "domain": "en.advertisercommunity.com",
  "dns": {
    "a": [
      "142.250.198.78"
    ],
    ...
    "cname": "support.google.com.",
    "mx": [],
    "ns": [],
    "spf": [
      "facebook-domain-verification=t8b7bl46eixt2ruofa08cd33sos8ts"
    ],
    "dmarc": [],
  ...
  "cors": [
    ...
    {
      "origin": "https://sub.en.advertisercommunity.com",
      "acao": "",
      "acac": ""
    }
  ],
  "http": {
    "status": 301,
    "location": "https://support.google.com/google-ads/community?ctx=lithium"
  },
  "redir_probes": [
