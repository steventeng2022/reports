...
Total findings: **13** (High: 1, Medium: 0, Low: 8, Info: 4)

| # | Severity | ID | Finding | CWE |
|---|---|---|---|---|
| 1 | high | B9 | Subdomain takeover candidate (dangling CNAME to shuttercorp.net) | CWE-1596 |
...
### 1. [HIGH] Subdomain takeover candidate (dangling CNAME to shuttercorp.net) (`B9`)

- **CWE:** CWE-1596
- **Detail:** Re-verified 2026-09-25 via DoH (dns.google): CNAME admin.shutterstock.com -> admin.us-east-1.shuttercorp.net (live); target returns NXDOMAIN (status 3); parent zone shuttercorp.net exists (status 0) but has no apex A record; https://admin.shutterstock.com is unreachable (TLS fetch fails). Dangling external-zone CNAME on a valuable brand.
...
- timing base=555ms id=546 search=193
...
**Stage 3 - live parameter harvest, takeover and injection probes (19 requests):**

- subdomains: ["admin.shutterstock.com -> admin.us-east-1.shuttercorp.net (NXDOMAIN target 3)"]
...
{
  "http_status": 301,
  "http_redirect_to": "https://shutterstock.com:443/",
  "https_status": 301,
  ...
  "subdomains": [
    "admin.shutterstock.com -> admin.us-east-1.shuttercorp.net (NXDOMAIN target 3)"
  ]
}
```
