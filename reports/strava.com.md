...
- **CWE:** CWE-200
- **Detail:** Apex TXT records with verification/token content: google-site-verification=z9engXe1IAxie3KkQEmv3FU2paPe3wciOlRip5-AyA8; google-site-verification=w4nbPkV1Xy_Sha-bUciA4fLF1L3jNqunS7B3BZ3jmk0; tiktok-developers-site-verification=TaDdWWlWycl7vyceILq930ykKqH5rE31
...
- **CWE:** CWE-200
- **Detail:** 54.192.248.128 carries PTR server-54-192-248-128.tpe53.r.cloudfront.net. for strava.com.
...
```json
{
  ...
  "x12": {
    "status": 301,
    "ptr": [
      "server-54-192-248-128.tpe53.r.cloudfront.net."
    ]
  },
  "elapsed_s": 14.5,
