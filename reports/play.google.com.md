...
- **CWE:** CWE-319
- **Detail:** Verified chain: http://play.google.com/ 302 -> http://play.google.com/store (plain HTTP hop) -> 301 -> https://play.google.com/store. Final destination is HTTPS; the intermediate plain-HTTP hop is informational.
...
{
  "http_status": 302,
  "http_redirect_to": "http://play.google.com/store",
  "https_status": 302,
