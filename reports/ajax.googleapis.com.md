...
- **CWE:** CWE-319
- **Detail:** http:// root answered 302 -> https://developers.google.com/speed/libraries/devguide.
- **Context:** https response, /
...
- **CWE:** CWE-603
- **Detail:** Certificate of ajax.googleapis.com has no Authority Information Access OCSP entry.
...
```json
{
  ...
  "cors": [
    ...
    {
      "origin": "https://sub.ajax.googleapis.com",
      "acao": "",
      "acac": ""
    }
  ],
