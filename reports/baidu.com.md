...
|---|---|---|---|---|
| 1 | info | T0 | TLS verification probe failed (transport) | CWE-200 |
| 2 | info | X1 | HTTPS homepage unreachable | CWE-200 |

## Detailed findings

### 1. [INFO] TLS verification probe failed (transport) (`T0`)

- **CWE:** CWE-200
- **Detail:** Strict TLS verification to baidu.com failed with TimeoutError: _ssl.c:993: The handshake operation timed out; no cert data captured - recheck manually.
