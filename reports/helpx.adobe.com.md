...
- **CWE:** CWE-603
- **Detail:** Certificate of helpx.adobe.com has no Authority Information Access OCSP entry.
- **Recommendation:** Enable OCSP (and stapling) so revocation can be checked.

### 13. [INFO] Reverse-DNS (PTR) fingerprint of apex IP (`PTR1`)

- **CWE:** CWE-200
- **Detail:** 203.121.225.79 carries PTR n225-h79.121.203.dynamic.da.net.tw. for helpx.adobe.com.
...
```json
{
  ...
  "dns": {
    ...
    "aaaa": [
      "2600:1417:e800::b81a:7f8b",
      "2600:1417:e800::b81a:7f8a"
    ],
    "cname": "helpx.adobe.com.edgesuite.net.",
    "mx": [],
    "ns": [],
    "spf": [],
    "dmarc": [],
  ...
  "cors": [
    ...
    {
      "origin": "https://sub.helpx.adobe.com",
      "acao": "",
      "acac": ""
    }
  ],
  "http": {
    "status": 301,
    "location": "https://helpx.adobe.com/"
  },
  "redir_probes": [
  ...
  "cname_chain": [
    "helpx.adobe.com.edgesuite.net",
    "a1027.dscd.akamai.net"
  ],
  "tls2": {
    "alpn": "",
    "tls_ver": "TLSv1.3",
