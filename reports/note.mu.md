...
| 12 | low | MAIL9 | DMARC enforces (p=quarantine) but has no reporting address (rua) | CWE-285 |
...
### 12. [LOW] DMARC enforces (p=quarantine) but has no reporting address (rua) (`MAIL9`)
...
- **CWE:** CWE-200
- **Detail:** Apex TXT records with verification/token content: google-site-verification=pygojOeujxnzFmgZCEygVTkWlsjhDGtT6AXh-5Gqa4A
- **Recommendation:** Review published verification records; they confirm domain ownership to third parties.

### 16. [INFO] No OCSP responder URL in certificate (no stapling possible) (`OCSP3`)

- **CWE:** CWE-603
- **Detail:** Certificate of note.mu has no Authority Information Access OCSP entry.
...
```json
{
  ...
  "tls": {
    ...
    "subject": "commonName=note.mu",
    "issuer": "countryName=US, organizationName=Amazon, commonName=Amazon RSA 2048 M01",
    "notBefore": "May 15 00:00:00 2026 GMT",
